...
module {
    ...
    public let ex1_tokens : [Types.Token] = [
        ...
        #startTag({
            attributes = [{ name = "xml:lang"; value = ?"en" }];
    ...
    public let ex1_doc : Types.Document = {
        version = ?{ major = 1; minor = 0 };
        encoding = ?"UTF-8";
        standalone = null;
        root = {
